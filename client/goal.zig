...
pub const struct__TDNF_ = extern struct {
    ...
    pub const TDNFSolvAddPkgLocks = __root.TDNFSolvAddPkgLocks;
    pub const TDNFSolvAddInstallOnlyPkgs = __root.TDNFSolvAddInstallOnlyPkgs;
    pub const GoalGetPkgNameFromHandle = __root.GoalGetPkgNameFromHandle;
    pub const TDNFFindCmdLinePkgPath = __root.TDNFFindCmdLinePkgPath;
    pub const TDNFSolvAddProtectPkgs = __root.TDNFSolvAddProtectPkgs;
    pub const TDNFGoalSolveNative = __root.TDNFGoalSolveNative;
    pub const TDNFGoalCaptureNativeSolve = __root.TDNFGoalCaptureNativeSolve;
    pub const TDNFGoalBuildNativeSolverRepoInputs = __root.TDNFGoalBuildNativeSolverRepoInputs;
    pub const TDNFGoalBuildNativeSolverJobs = __root.TDNFGoalBuildNativeSolverJobs;
    pub const TDNFGoalBuildNativeSolverHiddenAvailable = __root.TDNFGoalBuildNativeSolverHiddenAvailable;
    pub const TDNFReportProblemsNative = __root.TDNFReportProblemsNative;
    pub const TDNFGoalFindProtectedInTransaction = __root.TDNFGoalFindProtectedInTransaction;
    pub const TDNFGoalLoadInstalledPkgs = __root.TDNFGoalLoadInstalledPkgs;
    pub const TDNFAddUserInstalledToJobs = __root.TDNFAddUserInstalledToJobs;
};
...
pub export fn TDNFGoal(arg_pTdnf: PTDNF, arg_pQueuePkgList: PTDNF_ID_LIST, arg_ppInfo: [*c]PTDNF_SOLVED_PKG_INFO, arg_nAlterType: TDNF_ALTERTYPE, arg_nUnresolved: c_int) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var pQueuePkgList = arg_pQueuePkgList;
    _ = &pQueuePkgList;
    var ppInfo = arg_ppInfo;
    _ = &ppInfo;
    var nAlterType = arg_nAlterType;
    _ = &nAlterType;
    var nUnresolved = arg_nUnresolved;
    _ = &nUnresolved;
    var dwError: u32 = 0;
    _ = &dwError;
    var queueJobs: TDNF_ID_LIST = TDNF_ID_LIST{
        .pnElements = null,
        .dwCount = 0,
        .dwCapacity = 0,
    };
    _ = &queueJobs;
    var nAllowErasing: c_int = 0;
    _ = &nAllowErasing;
    var ppszExcludes: [*c][*c]u8 = null;
    _ = &ppszExcludes;
    var dwExcludeCount: u32 = 0;
    _ = &dwExcludeCount;
    ...
    const extern_local_TDNFPkgsToExclude = struct {
        extern fn TDNFPkgsToExclude(pTdnf: PTDNF, pdwPkgsToExclude: [*c]u32, pppszExclude: [*c][*c][*c]u8) u32;
    };
    _ = &extern_local_TDNFPkgsToExclude;
    ...
    if (nAlterType == @as(TDNF_ALTERTYPE, ALTER_UPGRADEALL)) {
        ...
        TDNFTransactionPlanRequestTraceRecordAllJob(pTdnf.*.pRequestTrace, nTraceStart / @as(u32, 2), 2, queueJobs.pnElements[nTraceStart], 0, 0, 0);
    } else if (nAlterType == @as(TDNF_ALTERTYPE, ALTER_DISTRO_SYNC)) {
        nTraceStart = queueJobs.dwCount;
        ...
        TDNFTransactionPlanRequestTraceRecordAllJob(pTdnf.*.pRequestTrace, nTraceStart / @as(u32, 2), 4, queueJobs.pnElements[nTraceStart], 0, 0, 0);
    } else {
        if ((pQueuePkgList.*.dwCount == @as(u32, 0)) and !(TDNFTransactionPlanStateIsEnabled(pTdnf.*.pTransactionPlanState) != 0)) {
        ...
        }
        {
            var i: u32 = 0;
            _ = &i;
            while (i < pQueuePkgList.*.dwCount) : (i +%= 1) {
                var dwId: TDNF_PKG_ID = pQueuePkgList.*.pnElements[i];
                _ = &dwId;
                _ = TDNFAddGoal(pTdnf, nAlterType, &queueJobs, dwId, dwExcludeCount, ppszExcludes);
            }
        }
    }
    nAllowErasing = @intFromBool((((pTdnf.*.pArgs.*.nAllowErasing != 0) or (nAlterType == @as(TDNF_ALTERTYPE, ALTER_ERASE))) or (nAlterType == @as(TDNF_ALTERTYPE, ALTER_AUTOERASE))) or (nAlterType == @as(TDNF_ALTERTYPE, ALTER_AUTOERASEALL)));
    if (nAllowErasing != 0) {
        dwError = TDNFAddUserInstalledToJobs(pTdnf, &queueJobs);
        if (dwError == @as(u32, ERROR_TDNF_HISTORY_NODB)) {
            dwError = 0;
        }
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
    ...
    dwError = rpmzSolv(pTdnf, &queueJobs, ppszExcludes, dwExcludeCount, nAllowErasing, @intFromBool(((pTdnf.*.pConf.*.nCleanRequirementsOnRemove != 0) and !(pTdnf.*.pArgs.*.nNoAutoRemove != 0)) or (nAlterType == @as(TDNF_ALTERTYPE, ALTER_AUTOERASE))), @intFromBool((nAlterType == @as(TDNF_ALTERTYPE, ALTER_REINSTALL)) or ((nAlterType == @as(TDNF_ALTERTYPE, ALTER_DISTRO_SYNC)) and (pTdnf.*.pConf.*.nDistroSyncReinstallChanged != 0))), nUnresolved, ppInfo);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    if (nAlterType == @as(TDNF_ALTERTYPE, ALTER_INSTALL)) {
...
pub export fn TDNFGoalNoDeps(arg_pTdnf: PTDNF, arg_pQueuePkgList: PTDNF_ID_LIST, arg_ppInfo: [*c]PTDNF_SOLVED_PKG_INFO) u32 {
    ...
    var dwError: u32 = 0;
    _ = &dwError;
    var ppszPackageRefs: [*c][*c]u8 = null;
    _ = &ppszPackageRefs;
    var dwRefCount: u32 = 0;
    _ = &dwRefCount;
    var pPkgInfo: PTDNF_PKG_INFO = null;
    _ = &pPkgInfo;
    ...
    if (!(pQueuePkgList.*.pnElements != null)) {
        dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + EINVAL));
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
    ...
    if (pQueuePkgList.*.dwCount == @as(u32, 0)) {
    ...
    dwError = TDNFNativeQuerySerializeQueuePackageRefs(pTdnf.*.pSack, pQueuePkgList, &ppszPackageRefs, &dwRefCount);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    dwError = TDNFPopulatePkgInfosFromRefs(pTdnf.*.pSack, ppszPackageRefs, dwRefCount, &pPkgInfo);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    dwError = TDNFAllocateMemory(1, @sizeOf(TDNF_SOLVED_PKG_INFO), @ptrCast(@alignCast(&pInfo)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
...
fn captureSolved(
    rpmz: PTDNF,
    native_solve: ?*anyopaque,
    accepted: u32,
    unresolved: u32,
    terminal_problem: u32,
    excludes: [*c][*c]u8,
    allow_erasing: c_int,
    clean_deps: c_int,
) u32 {
    if (TDNFTransactionPlanStateIsEnabled(rpmz.*.pTransactionPlanState) == 0) return 0;
    ...
    var environment = transaction_plan_abi.IntegrationEnvironment{
        .architecture = rpmz.*.pConf.*.pszBaseArch,
        .distro = rpmz.*.pConf.*.pszOSName,
        .releasever = rpmz.*.pConf.*.pszVarReleaseVer,
        .force_architecture = rpmz.*.pArgs.*.pszArch,
        .excludes = @ptrCast(excludes),
        .installonly_names = @ptrCast(rpmz.*.pConf.*.ppszInstallOnlyPkgs),
        .locked_names = @ptrCast(rpmz.*.pConf.*.ppszPkgLocks),
        .min_versions = @ptrCast(rpmz.*.pConf.*.ppszMinVersions),
        .protected_names = @ptrCast(rpmz.*.pConf.*.ppszProtectedPkgs),
        .rpm_config = rpmz.*.pRpmConfig,
        .installonly_limit = @bitCast(rpmz.*.pConf.*.nInstallOnlyLimit),
        .allow_erasing = @intFromBool(allow_erasing != 0),
        .allow_multilib = 1,
        .all_deps = @intFromBool(rpmz.*.pArgs.*.nAllDeps != 0),
        .best = @intFromBool(rpmz.*.pArgs.*.nBest != 0),
        .clean_requirements_on_remove = @intFromBool(clean_deps != 0),
        .include_installed = @intFromBool(rpmz.*.pArgs.*.nAllDeps == 0),
        .install_weak_dependencies = 1,
        .keep_orphans = 1,
        .skip_broken = @intFromBool(rpmz.*.pArgs.*.nSkipBroken != 0),
    };

    var rc = TDNFTransactionPlanRequestTraceGetError(rpmz.*.pRequestTrace);
    if (rc != 0) {
        return rc;
    }
    rc = TDNFGoalBuildNativeSolverRepoInputs(rpmz, &repos, &repo_count);
    if (rc == ERROR_TDNF_NO_DATA) rc = 0;
    if (rc != 0) {
        return rc;
    }
    ...
    if (repo_count != 0) {
        ...
        while (repo_index < repo_count) : (repo_index += 1) {
            var repo_data = rpmz.*.pRepos;
            while (repo_data != null and
                (repo_data.*.pRepo == null or repo_data.*.pszId == null or repo_data.*.pszId.* == 0 or
                    strcmp(repo_data.*.pszId, repos[repo_index].pszId) != 0))
            {
                repo_data = repo_data.*.pNext;
            }
            if (repo_data == null) return ERROR_TDNF_SOLV_FAILED;
            capture_repos[repo_index] = .{
                .repository = repo_data.*.pRepo,
                .id = repos[repo_index].pszId,
    ...
    rc = TDNFTransactionPlanIntegrationCapturePending(
        rpmz.*.pTransactionPlanState,
        rpmz.*.pSack,
        native_solve,
        TDNFTransactionPlanRequestTraceGetView(rpmz.*.pRequestTrace),
        accepted,
        unresolved,
        terminal_problem,
        capture_repos,
...
fn captureFailure(
    ...
    prepare_only: c_int,
    refute_unsat: c_int,
    drop_protected: c_int,
    native_solve: *?*anyopaque,
    original_error: u32,
) u32 {
    var rc = TDNFGoalCaptureNativeSolve(rpmz, jobs, allow_erasing, auto_erase, flags, stamped_count, prepare_only, refute_unsat, drop_protected, native_solve);
    if (rc != 0) {
        TDNFTransactionPlanStateClear(rpmz.*.pTransactionPlanState);
        return original_error;
    }
    TDNFTransactionPlanRequestTraceFinalize(rpmz.*.pRequestTrace, jobs.*.pnElements, jobs.*.dwCount, TDNF_JOB_CLEANDEPS, TDNF_JOB_FORCEBEST);
    rc = captureSolved(rpmz, native_solve.*, 0, @bitCast(unresolved), terminal_problem, excludes, allow_erasing, auto_erase);
    if (rc != 0) TDNFTransactionPlanStateClear(rpmz.*.pTransactionPlanState);
    return original_error;
}

fn rpmzSolv(
    pTdnf: PTDNF,
    pQueueJobs: PTDNF_ID_LIST,
    ppszExcludes: [*c][*c]u8,
    dwExcludeCount: u32,
    nAllowErasing: c_int,
    nAutoErase: c_int,
    nReInstall: c_int,
    nUnresolved: c_int,
    ppInfo: [*c]PTDNF_SOLVED_PKG_INFO,
) callconv(.c) u32 {
    var rc: u32 = 0;
    var info: PTDNF_SOLVED_PKG_INFO = null;
    var skip_problem: TDNF_SKIPPROBLEM_TYPE = SKIPPROBLEM_NONE;
    var flags: c_int = 0;
    var stamped_count: c_int = 0;
    var native_solve: ?*anyopaque = null;
    var installed: PTDNF_PKG_INFO = null;
    var installed_count: u32 = 0;
    defer {
        if (installed != null) TDNFFreePackageInfoArray(installed, installed_count);
        TDNFRepoMdNativeSolverLiveSolveRelease(native_solve);
    }
    ...
    solve: {
        if (pTdnf == null or ppInfo == null) {
            rc = ERROR_TDNF_INVALID_PARAMETER;
            break :solve;
        }
        ppInfo.* = null;
        TDNFTransactionPlanRequestTraceRecordPolicies(pTdnf.*.pRequestTrace, @ptrCast(ppszExcludes), @ptrCast(pTdnf.*.pConf.*.ppszInstallOnlyPkgs), @ptrCast(pTdnf.*.pConf.*.ppszPkgLocks), @ptrCast(pTdnf.*.pConf.*.ppszMinVersions), @ptrCast(pTdnf.*.pConf.*.ppszProtectedPkgs), @intFromBool(nAllowErasing != 0));
        if (pTdnf.*.pArgs.*.nBest != 0) flags |= TDNF_JOB_FORCEBEST;
        if (nAutoErase != 0) flags |= TDNF_JOB_CLEANDEPS;
        stamped_count = @bitCast(pQueueJobs.*.dwCount);
        var job_index: u32 = 0;
        while (job_index < pQueueJobs.*.dwCount) : (job_index += 2) pQueueJobs.*.pnElements[job_index] |= flags;

        if (dwExcludeCount != 0 and ppszExcludes != null and pTdnf.*.pSack == null) {
            rc = ERROR_TDNF_INVALID_PARAMETER;
            break :solve;
        }
        if ((pTdnf.*.pConf.*.ppszInstallOnlyPkgs != null and pTdnf.*.pConf.*.ppszInstallOnlyPkgs[0] != null) or
            (pTdnf.*.pConf.*.ppszPkgLocks != null and pTdnf.*.pConf.*.ppszPkgLocks[0] != null))
        {
            rc = TDNFGoalLoadInstalledPkgs(pTdnf, &installed, &installed_count);
            if (rc != 0) break :solve;
        }
        rc = TDNFSolvAddInstallOnlyPkgs(pTdnf, pQueueJobs, installed, installed_count);
        if (rc != 0) break :solve;
        rc = TDNFSolvAddPkgLocks(pTdnf, pQueueJobs, installed, installed_count);
        if (rc != 0) break :solve;
        rc = TDNFGoalAddHiddenPackages(pTdnf, if (dwExcludeCount != 0) ppszExcludes else null);
        if (rc != 0) break :solve;
        ...
        if (rc == ERROR_TDNF_PROTECTED or ((rc == ERROR_TDNF_CALL_NOT_SUPPORTED or rc == ERROR_TDNF_SOLV_FAILED) and pTdnf.*.pConf.*.ppszProtectedPkgs != null)) {
            var protected_name: [*c]const u8 = null;
        ...
        if (rc == ERROR_TDNF_SOLV_FAILED) {
            rc = TDNFGetSkipProblemOption(pTdnf, &skip_problem);
            if (rc != 0) break :solve;
        ...
        if (rc != 0) break :solve;
        rc = captureSolved(pTdnf, native_solve, 0, @bitCast(nUnresolved), 0xffffffff, ppszExcludes, nAllowErasing, nAutoErase);
        if (rc != 0) break :solve;
        ppInfo.* = info;
        info = null;
    }
    ...
    if (rc != 0) {
        if (pTdnf != null and TDNFTransactionPlanStateHasPendingProblem(pTdnf.*.pTransactionPlanState) == 0) TDNFTransactionPlanStateClear(pTdnf.*.pTransactionPlanState);
        if (info != null) TDNFFreeMemory(info);
        if (ppInfo != null) ppInfo.* = null;
    }
    return rc;
}

pub export fn TDNFAddUserInstall(arg_pTdnf: PTDNF, arg_pQueueGoal: [*c]const TDNF_ID_LIST, arg_ppInfo: PTDNF_SOLVED_PKG_INFO) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    ...
    dwError = TDNFAllocateMemory(pQueueGoal.*.dwCount +% @as(u32, 1), @sizeOf([*c][*c]u8), @ptrCast(@alignCast(&ppszPkgsUserInstall)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    {
        i = 0;
        while (i < @as(c_int, @bitCast(@as(c_uint, @truncate(pQueueGoal.*.dwCount))))) : (i += 1) {
            dwError = GoalGetPkgNameFromHandle(pTdnf, pQueueGoal.*.pnElements[@bitCast(@as(isize, @intCast(i)))], &ppszPkgsUserInstall[@bitCast(@as(isize, @intCast(i)))]);
            while (true) {
                if (dwError != @as(u32, 0)) return dwError;
                if (!false) break;
            }
...
pub export fn TDNFMarkAutoInstalled(arg_pTdnf: PTDNF, arg_pHistoryCtx: ?*struct_history_ctx, arg_ppInfo: PTDNF_SOLVED_PKG_INFO, arg_nAutoOnly: c_int) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var pHistoryCtx = arg_pHistoryCtx;
    _ = &pHistoryCtx;
    var ppInfo = arg_ppInfo;
    _ = &ppInfo;
    var nAutoOnly = arg_nAutoOnly;
    _ = &nAutoOnly;
    var dwError: u32 = 0;
    _ = &dwError;
    var pPkgInfo: PTDNF_PKG_INFO = null;
    _ = &pPkgInfo;
    if ((!(pTdnf != null) or !(pHistoryCtx != null)) or !(ppInfo != null)) {
        dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + EINVAL));
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
    ...
    {
        pPkgInfo = ppInfo.*.pPkgsToInstall;
        while (pPkgInfo != null) : (pPkgInfo = pPkgInfo.*.pNext) {
            var pszName: [*c]const u8 = pPkgInfo.*.pszName;
            _ = &pszName;
            var nFlag: c_int = 1;
            _ = &nFlag;
            if (ppInfo.*.ppszPkgsUserInstall != null) {
                {
                    var i: c_int = 0;
                    _ = &i;
                    while (ppInfo.*.ppszPkgsUserInstall[@bitCast(@as(isize, @intCast(i)))] != null) : (i += 1) {
                        if (strcmp(pszName, ppInfo.*.ppszPkgsUserInstall[@bitCast(@as(isize, @intCast(i)))]) == @as(c_int, 0)) {
                            nFlag = 0;
                            break;
                        }
                    }
            ...
            if (((nFlag == @as(c_int, 1)) and (pTdnf.*.pConf != null)) and (pTdnf.*.pConf.*.ppszInstallOnlyPkgs != null)) {
                {
                    var i: c_int = 0;
                    _ = &i;
                    while (pTdnf.*.pConf.*.ppszInstallOnlyPkgs[@bitCast(@as(isize, @intCast(i)))] != null) : (i += 1) {
                        if (strcmp(pTdnf.*.pConf.*.ppszInstallOnlyPkgs[@bitCast(@as(isize, @intCast(i)))], pszName) == @as(c_int, 0)) {
                            var value: c_int = 0;
                            _ = &value;
                            var rc: c_int = history_get_auto_flag(pHistoryCtx, pszName, &value);
                            _ = &rc;
                            if (rc != @as(c_int, 0)) {
                                dwError = ERROR_TDNF_HISTORY_ERROR;
                                while (true) {
            ...
            if (!(nAutoOnly != 0) or (nFlag == @as(c_int, 1))) {
                var rc: c_int = history_set_auto_flag(pHistoryCtx, pszName, nFlag);
                _ = &rc;
                if (rc != @as(c_int, 0)) {
                    dwError = ERROR_TDNF_HISTORY_ERROR;
                    while (true) {
...
pub export fn TDNFAddGoal(arg_pTdnf: PTDNF, arg_nAlterType: TDNF_ALTERTYPE, arg_pQueueJobs: PTDNF_ID_LIST, arg_dwId: TDNF_PKG_ID, arg_dwCount: u32, arg_ppszExcludes: [*c][*c]u8) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var nAlterType = arg_nAlterType;
    _ = &nAlterType;
    ...
    var dwId = arg_dwId;
    _ = &dwId;
    var dwCount = arg_dwCount;
    _ = &dwCount;
    var ppszExcludes = arg_ppszExcludes;
    _ = &ppszExcludes;
    var dwError: u32 = 0;
    _ = &dwError;
    var ppszPackagesTemp: [*c][*c]u8 = null;
    _ = &ppszPackagesTemp;
    var pszName: [*c]u8 = null;
    _ = &pszName;
    var nTraceStart: u32 = 0;
    _ = &nTraceStart;
    var excluded = false;
    ...
    if ((dwCount != @as(u32, 0)) and (ppszExcludes != null)) {
        ...
        while ((ppszPackagesTemp != null) and (ppszPackagesTemp.* != null)) {
            if (TDNFIsGlob(ppszPackagesTemp.*) != 0) {
                if (!(fnmatch(ppszPackagesTemp.*, pszName, 0) != 0)) {
                    excluded = true;
                    break;
                }
            } else if (!(strcmp(pszName, ppszPackagesTemp.*) != 0)) {
                excluded = true;
                break;
            }
            ppszPackagesTemp += 1;
    ...
    if (!excluded) {
        while (true) {
            switch (nAlterType) {
                @as(TDNF_ALTERTYPE, ALTER_DOWNGRADEALL), @as(TDNF_ALTERTYPE, ALTER_DOWNGRADE) => {
                    dwError = TDNFIdListPush2(pQueueJobs, TDNF_JOB_SOLVABLE | TDNF_JOB_INSTALL, dwId);
                    if (dwError != 0) return dwError;
                    break;
                },
                @as(TDNF_ALTERTYPE, ALTER_ERASE), @as(TDNF_ALTERTYPE, ALTER_AUTOERASE), @as(TDNF_ALTERTYPE, ALTER_AUTOERASEALL) => {
                    dwError = TDNFIdListPush2(pQueueJobs, TDNF_JOB_SOLVABLE | TDNF_JOB_ERASE, dwId);
                    if (dwError != 0) return dwError;
                    break;
                },
                @as(TDNF_ALTERTYPE, ALTER_REINSTALL), @as(TDNF_ALTERTYPE, ALTER_INSTALL), @as(TDNF_ALTERTYPE, ALTER_UPGRADE) => {
                    dwError = TDNFIdListPush2(pQueueJobs, TDNF_JOB_SOLVABLE | TDNF_JOB_INSTALL, dwId);
                    if (dwError != 0) return dwError;
                    break;
                },
                else => return ERROR_TDNF_INVALID_RESOLVE_ARG,
            }
            break;
        }
    }
...
pub export fn TDNFGoalAddHiddenPackages(arg_pTdnf: PTDNF, arg_ppszExcludes: [*c][*c]u8) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var ppszExcludes = arg_ppszExcludes;
    _ = &ppszExcludes;
    var dwError: u32 = 0;
    _ = &dwError;
    var ppszExcludeLines: [*c][*c]u8 = null;
    _ = &ppszExcludeLines;
    var ppszMinVersionLines: [*c][*c]u8 = null;
    _ = &ppszMinVersionLines;
    var ppszHiddenRefs: [*c][*c]u8 = null;
    _ = &ppszHiddenRefs;
    var dwExcludeLineCount: u32 = 0;
    _ = &dwExcludeLineCount;
    var dwMinVersionLineCount: u32 = 0;
    _ = &dwMinVersionLineCount;
    var dwHiddenRefCount: u32 = 0;
    _ = &dwHiddenRefCount;
    ...
    while (true) {
        if (pTdnf.*.ppszHiddenRefs != null) {
            TDNFFreeStringArray(pTdnf.*.ppszHiddenRefs);
            pTdnf.*.ppszHiddenRefs = null;
        }
        if (!false) break;
    }
    pTdnf.*.dwHiddenRefCount = 0;
    if (!(ppszExcludes != null) and !(pTdnf.*.pConf.*.ppszMinVersions != null)) {
        return dwError;
    }
    ...
    if (ppszExcludes != null) {
        dwError = TDNFRepoMdNativeExcludeLinesConfig(pRepos, dwRepoCount, pTdnf.*.pRpmConfig, ppszExcludes, &ppszExcludeLines, &dwExcludeLineCount);
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
        }
    }
    if (pTdnf.*.pConf.*.ppszMinVersions != null) {
        dwError = TDNFRepoMdNativeMinVersionExcludeLinesConfig(pRepos, dwRepoCount, pTdnf.*.pRpmConfig, pTdnf.*.pConf.*.ppszMinVersions, &ppszMinVersionLines, &dwMinVersionLineCount);
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
        }
    }
    if ((dwExcludeLineCount == @as(u32, 0)) and (dwMinVersionLineCount == @as(u32, 0))) {
        return dwError;
    }
    dwError = TDNFAllocateMemory((dwExcludeLineCount +% dwMinVersionLineCount) +% @as(u32, 1), @sizeOf([*c]u8), @ptrCast(@alignCast(&ppszHiddenRefs)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    {
        i = 0;
        while (i < (dwExcludeLineCount +% dwMinVersionLineCount)) : (i +%= 1) {
            var pszLine: [*c]const u8 = if (i < dwExcludeLineCount) ppszExcludeLines[i] else ppszMinVersionLines[i -% dwExcludeLineCount];
            _ = &pszLine;
            var dwSeen: u32 = 0;
            _ = &dwSeen;
            {
                dwSeen = 0;
                while (dwSeen < dwHiddenRefCount) : (dwSeen +%= 1) {
                    if (!(strcmp(ppszHiddenRefs[dwSeen], pszLine) != 0)) {
                        break;
                    }
                }
            }
    ...
    {
        i = 0;
        while (i < dwHiddenRefCount) : (i +%= 1) {
            var dwPkgId: TDNF_PKG_ID = 0;
            _ = &dwPkgId;
            dwError = TDNFNativeQueryResolveSinglePackageRef(pTdnf.*.pSack, ppszHiddenRefs[i], 0, &dwPkgId);
            while (true) {
                if (dwError != @as(u32, 0)) return dwError;
                if (!false) break;
            }
...
pub extern fn TDNFPrepareAllPackages(pTdnf: PTDNF, pAlterType: [*c]TDNF_ALTERTYPE, ppszPkgsNotResolved: [*c][*c]u8, pQueueGoal: PTDNF_ID_LIST) u32;
pub extern fn TDNFAddNotResolved(ppszPkgsNotResolved: [*c][*c]u8, pszPkgName: [*c]const u8) u32;
pub extern fn TDNFResolveBuildDependencies(pTdnf: PTDNF, ppszPackageNameSpecs: [*c][*c]u8, ppszPkgsNotResolved: [*c][*c]u8, queueGoal: PTDNF_ID_LIST) u32;
...
pub export fn TDNFReportNativeSolverProblems(arg_pHandle: ?*anyopaque, arg_dwSkipProblem: TDNF_SKIPPROBLEM_TYPE) u32 {
    var pHandle = arg_pHandle;
    _ = &pHandle;
    var dwSkipProblem = arg_dwSkipProblem;
    _ = &dwSkipProblem;
    var dwError: u32 = 0;
    _ = &dwError;
    var dwCount: u32 = 0;
    _ = &dwCount;
    var total_prblms: u32 = 0;
    _ = &total_prblms;
    var i: u32 = 0;
    _ = &i;
    if (!(pHandle != null)) {
    ...
    }
    {
        ...
        while (i < dwCount) : (i +%= 1) {
            var nReported: u32 = 0;
            _ = &nReported;
            var pszMessage: [*c]const u8 = null;
            _ = &pszMessage;
            dwError = TDNFRepoMdNativeSolverRefutedProblem(pHandle, i, dwSkipProblem, &nReported, &pszMessage);
            while (true) {
                if (dwError != @as(u32, 0)) return dwError;
                if (!false) break;
            }
...
pub fn TDNFSolvAddPkgLocks(arg_pTdnf: PTDNF, arg_pQueueJobs: PTDNF_ID_LIST, arg_pInstalled: PTDNF_PKG_INFO, arg_dwInstalledCount: u32) callconv(.c) u32 {
    ...
    var pQueueJobs = arg_pQueueJobs;
    _ = &pQueueJobs;
    var pInstalled = arg_pInstalled;
    _ = &pInstalled;
    var dwInstalledCount = arg_dwInstalledCount;
    _ = &dwInstalledCount;
    var dwError: u32 = 0;
    _ = &dwError;
    var i: c_int = undefined;
    ...
    {
        i = 0;
        while ((pTdnf.*.pConf.*.ppszPkgLocks != null) and (pTdnf.*.pConf.*.ppszPkgLocks[@bitCast(@as(isize, @intCast(i)))] != null)) : (i += 1) {
            var pszPkg: [*c]u8 = pTdnf.*.pConf.*.ppszPkgLocks[@bitCast(@as(isize, @intCast(i)))];
            _ = &pszPkg;
            if (!(pszPkg != null) or !(@as(c_int, pszPkg.*) != 0)) continue;
            if (TDNFGoalNameIsInstalled(pszPkg, pInstalled, dwInstalledCount) != 0) {
                dwError = TDNFIdListPush2(pQueueJobs, TDNF_JOB_SOLVABLE_NAME | TDNF_JOB_LOCK, i);
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
                }
                TDNFTransactionPlanRequestTraceRecordNameJob(pTdnf.*.pRequestTrace, (pQueueJobs.*.dwCount / @as(u32, 2)) -% @as(u32, 1), 6, pszPkg, TDNF_JOB_SOLVABLE_NAME | TDNF_JOB_LOCK, 0, 5, @as(c_uint, 4294967295));
            }
        }
    }
    return dwError;
}
pub fn TDNFSolvAddInstallOnlyPkgs(arg_pTdnf: PTDNF, arg_pQueueJobs: PTDNF_ID_LIST, arg_pInstalled: PTDNF_PKG_INFO, arg_dwInstalledCount: u32) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var pQueueJobs = arg_pQueueJobs;
    _ = &pQueueJobs;
    ...
    {
        i = 0;
        while ((ppszPackages != null) and (ppszPackages[@bitCast(@as(isize, @intCast(i)))] != null)) : (i += 1) {
            var pszPkg: [*c]u8 = ppszPackages[@bitCast(@as(isize, @intCast(i)))];
            _ = &pszPkg;
            if (!(pszPkg != null) or !(@as(c_int, pszPkg.*) != 0)) {
                continue;
            }
            if (TDNFGoalNameIsInstalled(pszPkg, pInstalled, dwInstalledCount) != 0) {
                ...
                TDNFTransactionPlanRequestTraceRecordNameJob(pTdnf.*.pRequestTrace, (pQueueJobs.*.dwCount / @as(u32, 2)) -% @as(u32, 1), 7, pszPkg, TDNF_JOB_SOLVABLE_NAME | TDNF_JOB_MULTIVERSION, 0, 5, @as(c_uint, 4294967295));
            }
        }
    }
    return dwError;
}
pub fn GoalGetPkgNameFromHandle(arg_pTdnf: PTDNF, arg_dwPkgId: TDNF_PKG_ID, arg_ppszName: [*c][*c]u8) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var dwPkgId = arg_dwPkgId;
    _ = &dwPkgId;
    var ppszName = arg_ppszName;
    _ = &ppszName;
    var dwError: u32 = 0;
    _ = &dwError;
    var dwEpoch: u32 = 0;
    _ = &dwEpoch;
    var pszRef: [*c]u8 = null;
    _ = &pszRef;
    var pszRepo: [*c]u8 = null;
    _ = &pszRepo;
    var pszName: [*c]u8 = null;
    _ = &pszName;
    var pszVersion: [*c]u8 = null;
    _ = &pszVersion;
    var pszRelease: [*c]u8 = null;
    _ = &pszRelease;
    ...
    dwError = TDNFNativeQuerySplitPackageRef(pszRef, &pszRepo, &dwEpoch, &pszName, &pszVersion, &pszRelease, &pszArch);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
...
pub fn TDNFFindCmdLinePkgPath(arg_pTdnf: PTDNF, arg_dwPkgId: TDNF_PKG_ID, arg_ppszPath: [*c][*c]u8) callconv(.c) u32 {
    ...
    {
        dwIndex = 0;
        while (dwIndex < pTdnf.*.dwCmdLinePkgCount) : (dwIndex +%= 1) {
            if (pTdnf.*.pdwCmdLinePkgIds[dwIndex] != dwPkgId) {
                continue;
            }
            dwError = TDNFAllocateString(pTdnf.*.ppszCmdLinePkgPaths[dwIndex], &pszPath);
            while (true) {
                if (dwError != @as(u32, 0)) return dwError;
                if (!false) break;
            }
...
pub fn TDNFSolvAddProtectPkgs(arg_pTdnf: PTDNF, arg_pQueueJobs: PTDNF_ID_LIST) callconv(.c) u32 {
    ...
    var dwError: u32 = 0;
    _ = &dwError;
    var ppszProtectedPkgs: [*c][*c]u8 = null;
    _ = &ppszProtectedPkgs;
    var pszWhatName: [*c]u8 = null;
    _ = &pszWhatName;
    var pszAddName: [*c]u8 = null;
    _ = &pszAddName;
    var pszInstalledName: [*c]u8 = null;
    _ = &pszInstalledName;
    var i: c_int = undefined;
    _ = &i;
    ...
    _ = &k;
    var qInstalled: TDNF_ID_LIST = TDNF_ID_LIST{
        .pnElements = null,
        .dwCount = 0,
        .dwCapacity = 0,
    };
    ...
    {
        j = 0;
        while (j < @as(c_int, @bitCast(@as(c_uint, @truncate(pQueueJobs.*.dwCount))))) : (j += 2) {
            var how: i32 = pQueueJobs.*.pnElements[@bitCast(@as(isize, @intCast(j)))];
            _ = &how;
            if (((how & TDNF_JOB_JOBMASK) == TDNF_JOB_ERASE) and ((how & TDNF_JOB_SOLVABLE) != 0)) {
                var what: TDNF_PKG_ID = pQueueJobs.*.pnElements[@bitCast(@as(isize, @intCast(j + @as(c_int, 1))))];
                _ = &what;
                var pszPkgName: [*c]const u8 = null;
                _ = &pszPkgName;
                while (true) {
                    if (pszWhatName != null) {
                ...
                if (pszPkgName != null) {
                    {
                        i = 0;
                        while (i < @as(c_int, @bitCast(@as(c_uint, @truncate(pQueueJobs.*.dwCount))))) : (i += 2) {
                            if (i == j) continue;
                            how = pQueueJobs.*.pnElements[@bitCast(@as(isize, @intCast(i)))];
                            if (((how & TDNF_JOB_JOBMASK) == TDNF_JOB_INSTALL) and ((how & TDNF_JOB_SOLVABLE) != 0)) {
                                var what_add: TDNF_PKG_ID = pQueueJobs.*.pnElements[@bitCast(@as(isize, @intCast(i + @as(c_int, 1))))];
                                _ = &what_add;
                                while (true) {
                                    if (pszAddName != null) {
                                ...
                                if (!(strcmp(pszAddName, pszWhatName) != 0)) {
                                    break;
                                }
                            }
                        }
    ...
    {
        k = 0;
        while (k < @as(c_int, @bitCast(@as(c_uint, @truncate(qInstalled.dwCount))))) : (k += 1) {
            var p: TDNF_PKG_ID = qInstalled.pnElements[@bitCast(@as(isize, @intCast(k)))];
            _ = &p;
            while (true) {
            ...
            if (!(GoalFindProtectedName(ppszProtectedPkgs, pszInstalledName) != null)) {
                dwError = TDNFIdListPush2(pQueueJobs, TDNF_JOB_SOLVABLE | TDNF_JOB_ALLOWUNINSTALL, p);
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
                }
                TDNFTransactionPlanRequestTraceRecordPackageJob(pTdnf.*.pRequestTrace, (pQueueJobs.*.dwCount / @as(u32, 2)) -% @as(u32, 1), 9, p, TDNF_JOB_SOLVABLE | TDNF_JOB_ALLOWUNINSTALL, 0, 5, @as(c_uint, 4294967295));
            } else {
                ...
                TDNFTransactionPlanRequestTraceRecordPackageJob(pTdnf.*.pRequestTrace, (pQueueJobs.*.dwCount / @as(u32, 2)) -% @as(u32, 1), 8, p, TDNF_JOB_SOLVABLE | TDNF_JOB_USERINSTALLED, 0, 5, @as(c_uint, 4294967295));
            }
        }
    }
    return dwError;
...
pub fn GoalFindProtectedName(arg_ppszProtectedPkgs: [*c][*c]u8, arg_pszName: [*c]const u8) callconv(.c) [*c]const u8 {
    var ppszProtectedPkgs = arg_ppszProtectedPkgs;
    _ = &ppszProtectedPkgs;
    var pszName = arg_pszName;
    _ = &pszName;
    var i: c_int = 0;
    _ = &i;
    if (!(ppszProtectedPkgs != null) or (!(pszName != null) or !(@as(c_int, pszName.*) != 0))) {
        return null;
    }
    {
        i = 0;
        while (ppszProtectedPkgs[@bitCast(@as(isize, @intCast(i)))] != null) : (i += 1) {
            if (!(strcmp(ppszProtectedPkgs[@bitCast(@as(isize, @intCast(i)))], pszName) != 0)) {
                return ppszProtectedPkgs[@bitCast(@as(isize, @intCast(i)))];
            }
        }
    }
    return null;
}
pub fn TDNFGoalSolveNative(arg_pTdnf: PTDNF, arg_pQueueJobs: [*c]const TDNF_ID_LIST, arg_nAllowErasing: c_int, arg_nAutoErase: c_int, arg_nStampFlags: c_int, arg_nStampedJobCount: c_int, arg_nReInstall: c_int, arg_ppInfo: [*c]PTDNF_SOLVED_PKG_INFO, arg_nPrepareOnly: c_int, arg_nRefuteUnsat: c_int, arg_nDropProtected: c_int, arg_ppHandle: [*c]?*anyopaque) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var pQueueJobs = arg_pQueueJobs;
    _ = &pQueueJobs;
    var nAllowErasing = arg_nAllowErasing;
    _ = &nAllowErasing;
    var nAutoErase = arg_nAutoErase;
    _ = &nAutoErase;
    var nStampFlags = arg_nStampFlags;
    _ = &nStampFlags;
    var nStampedJobCount = arg_nStampedJobCount;
    _ = &nStampedJobCount;
    var nReInstall = arg_nReInstall;
    _ = &nReInstall;
    var ppInfo = arg_ppInfo;
    _ = &ppInfo;
    var nPrepareOnly = arg_nPrepareOnly;
    _ = &nPrepareOnly;
    var nRefuteUnsat = arg_nRefuteUnsat;
    _ = &nRefuteUnsat;
    var nDropProtected = arg_nDropProtected;
    _ = &nDropProtected;
    var ppHandle = arg_ppHandle;
    _ = &ppHandle;
    var dwError: u32 = 0;
    _ = &dwError;
    var dwRepoCount: u32 = 0;
    _ = &dwRepoCount;
    var dwJobCount: u32 = 0;
    _ = &dwJobCount;
    var dwEraseJobCount: u32 = 0;
    _ = &dwEraseJobCount;
    var dwHiddenAvailableCount: u32 = 0;
    _ = &dwHiddenAvailableCount;
    var nUpdateAll: c_int = 0;
    _ = &nUpdateAll;
    var nDistSyncAll: c_int = 0;
    _ = &nDistSyncAll;
    var dwGlobalQueuePair: u32 = 0;
    _ = &dwGlobalQueuePair;
    var nHasGlobalQueuePair: c_int = 0;
    _ = &nHasGlobalQueuePair;
    var pRepos: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_REPOSITORY_V16 = null;
    _ = &pRepos;
    var pJobs: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB = null;
    _ = &pJobs;
    var pEraseJobs: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB = null;
    _ = &pEraseJobs;
    var pHiddenAvailable: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB = null;
    _ = &pHiddenAvailable;
    var ppszInstallOnlyPkgs: [*c][*c]u8 = null;
    _ = &ppszInstallOnlyPkgs;
    var ppszUserInstalledPkgs: [*c][*c]u8 = null;
    _ = &ppszUserInstalledPkgs;
    var ppszLockedPkgs: [*c][*c]u8 = null;
    _ = &ppszLockedPkgs;
    ...
    _ = &pszNativeArch;
    var pszNativeArchOwned: [*c]u8 = null;
    _ = &pszNativeArchOwned;
    var pInfo: PTDNF_SOLVED_PKG_INFO = null;
    _ = &pInfo;
    ...
    if (!(!(pTdnf.*.pArgs.*.pszArch != null) or !(@as(c_int, pTdnf.*.pArgs.*.pszArch.*) != 0))) {
    ...
    if (!(pszNativeArch != null) or !(@as(c_int, pszNativeArch.*) != 0)) {
        dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENODATA));
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
    ...
    dwError = TDNFGoalBuildNativeSolverRepoInputs(pTdnf, &pRepos, &dwRepoCount);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    ...
    if ((@as(u32, @bitCast(@as(c_int, @intFromBool(!(nAllowErasing != 0))))) != 0) and (dwEraseJobCount != 0)) {
        dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
        }
    }
    dwError = TDNFGoalBuildNativeSolverHiddenAvailable(pTdnf, &pHiddenAvailable, &dwHiddenAvailableCount);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    ...
    if (!(nPrepareOnly != 0) and !(nRefuteUnsat != 0)) {
        ppInfo.* = pInfo;
        pInfo = null;
    }
    return dwError;
...
pub fn TDNFGoalCaptureNativeSolve(arg_pTdnf: PTDNF, arg_pQueueJobs: [*c]const TDNF_ID_LIST, arg_nAllowErasing: c_int, arg_nAutoErase: c_int, arg_nStampFlags: c_int, arg_nStampedJobCount: c_int, arg_nPrepareOnly: c_int, arg_nRefuteUnsat: c_int, arg_nDropProtected: c_int, arg_ppHandle: [*c]?*anyopaque) callconv(.c) u32 {
    ...
    dwError = TDNFGoalSolveNative(pTdnf, pQueueJobs, nAllowErasing, nAutoErase, nStampFlags, nStampedJobCount, 0, @ptrCast(@alignCast(if ((nPrepareOnly != 0) or (nRefuteUnsat != 0)) @as(?*anyopaque, null) else @as(?*anyopaque, @ptrCast(@alignCast(&pInfo))))), nPrepareOnly, nRefuteUnsat, nDropProtected, ppHandle);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
...
pub fn TDNFGoalBuildNativeSolverRepoInputs(arg_pTdnf: PTDNF, arg_ppRepos: [*c]PTDNF_REPOMD_NATIVE_SOLVER_LIVE_REPOSITORY_V16, arg_pdwRepoCount: [*c]u32) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var ppRepos = arg_ppRepos;
    _ = &ppRepos;
    var pdwRepoCount = arg_pdwRepoCount;
    _ = &pdwRepoCount;
    var dwError: u32 = 0;
    _ = &dwError;
    var dwCount: u32 = 0;
    ...
    }
    {
        ...
        while (pRepoData != null) : (pRepoData = pRepoData.*.pNext) {
            if ((((pRepoData.*.nEnabled != 0) and ((pRepoData.*.nHasMetaData != 0) or ((if ((!(pRepoData.*.nHasMetaData != 0) and (pRepoData.*.ppszBaseUrls != null)) and !(!(pRepoData.*.ppszBaseUrls[@as(c_int, 0)] != null) or !(@as(c_int, pRepoData.*.ppszBaseUrls[@as(c_int, 0)].*) != 0))) @as(?*anyopaque, @ptrCast(@alignCast(pRepoData.*.ppszBaseUrls[@as(c_int, 0)]))) else @as(?*anyopaque, null)) != null))) and (pRepoData.*.pRepo != null)) and !(!(pRepoData.*.pszId != null) or !(@as(c_int, pRepoData.*.pszId.*) != 0))) {
                dwCount +%= 1;
            }
        }
    }
    if (dwCount != 0) {
        dwError = TDNFAllocateMemory(dwCount, @sizeOf(@TypeOf(pRepos.*)), @ptrCast(@alignCast(&pRepos)));
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
        }
    ...
    dwCount = 0;
    {
        pRepoData = pTdnf.*.pRepos;
        while (pRepoData != null) : (pRepoData = pRepoData.*.pNext) {
            if (((!(pRepoData.*.nEnabled != 0) or (!(pRepoData.*.nHasMetaData != 0) and !((if ((!(pRepoData.*.nHasMetaData != 0) and (pRepoData.*.ppszBaseUrls != null)) and !(!(pRepoData.*.ppszBaseUrls[@as(c_int, 0)] != null) or !(@as(c_int, pRepoData.*.ppszBaseUrls[@as(c_int, 0)].*) != 0))) @as(?*anyopaque, @ptrCast(@alignCast(pRepoData.*.ppszBaseUrls[@as(c_int, 0)]))) else @as(?*anyopaque, null)) != null))) or !(pRepoData.*.pRepo != null)) or (!(pRepoData.*.pszId != null) or !(@as(c_int, pRepoData.*.pszId.*) != 0))) {
                continue;
            }
            pRepos[dwCount].pszDirectory = @ptrCast(@alignCast(if ((!(pRepoData.*.nHasMetaData != 0) and (pRepoData.*.ppszBaseUrls != null)) and !(!(pRepoData.*.ppszBaseUrls[@as(c_int, 0)] != null) or !(@as(c_int, pRepoData.*.ppszBaseUrls[@as(c_int, 0)].*) != 0))) @as(?*anyopaque, @ptrCast(@alignCast(pRepoData.*.ppszBaseUrls[@as(c_int, 0)]))) else @as(?*anyopaque, null)));
            if (!(pRepos[dwCount].pszDirectory != null)) {
                dwError = TDNFGetCachePath(pTdnf, pRepoData, null, null, @ptrCast(@alignCast(&pRepos[dwCount].pszCacheDir)));
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
                }
...
pub fn TDNFGoalFreeNativeSolverRepoInputs(arg_pRepos: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_REPOSITORY_V16, arg_dwRepoCount: u32) callconv(.c) void {
    var pRepos = arg_pRepos;
    _ = &pRepos;
    var dwRepoCount = arg_dwRepoCount;
    _ = &dwRepoCount;
    var dwIndex: u32 = 0;
    _ = &dwIndex;
    if (!(pRepos != null)) {
    ...
    {
        dwIndex = 0;
        while (dwIndex < dwRepoCount) : (dwIndex +%= 1) {
            var pszCacheDir: [*c]u8 = @ptrCast(@alignCast(@constCast(pRepos[dwIndex].pszCacheDir)));
            _ = &pszCacheDir;
            while (true) {
                if (pszCacheDir != null) {
                    TDNFFreeMemory(@ptrCast(@alignCast(pszCacheDir)));
                    pszCacheDir = null;
                }
                if (!false) break;
            }
    ...
    while (true) {
        if (pRepos != null) {
            TDNFFreeMemory(@ptrCast(@alignCast(pRepos)));
            pRepos = null;
        }
        if (!false) break;
    }
...
pub fn TDNFGoalBuildNativeSolverJobs(arg_pTdnf: PTDNF, arg_pQueueJobs: [*c]const TDNF_ID_LIST, arg_nStampFlags: c_int, arg_nStampedJobCount: c_int, arg_ppJobs: [*c]PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB, arg_pdwJobCount: [*c]u32, arg_ppEraseJobs: [*c]PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB, arg_pdwEraseJobCount: [*c]u32, arg_pppszInstallOnlyPkgs: [*c][*c][*c]u8, arg_pppszUserInstalledPkgs: [*c][*c][*c]u8, arg_ppdwUserInstalledQueuePairs: [*c][*c]u32, arg_pppszLockedPkgs: [*c][*c][*c]u8, arg_ppdwLockedQueuePairs: [*c][*c]u32, arg_pppszCmdLinePaths: [*c][*c][*c]u8, arg_pnUpdateAll: [*c]c_int, arg_pnDistSyncAll: [*c]c_int, arg_pdwGlobalQueuePair: [*c]u32, arg_pnHasGlobalQueuePair: [*c]c_int) callconv(.c) u32 {
    ...
    var nStampedJobCount = arg_nStampedJobCount;
    _ = &nStampedJobCount;
    var ppJobs = arg_ppJobs;
    _ = &ppJobs;
    var pdwJobCount = arg_pdwJobCount;
    _ = &pdwJobCount;
    var ppEraseJobs = arg_ppEraseJobs;
    _ = &ppEraseJobs;
    var pdwEraseJobCount = arg_pdwEraseJobCount;
    _ = &pdwEraseJobCount;
    var pppszInstallOnlyPkgs = arg_pppszInstallOnlyPkgs;
    ...
    _ = &ppdwLockedQueuePairs;
    var pppszCmdLinePaths = arg_pppszCmdLinePaths;
    _ = &pppszCmdLinePaths;
    var pnUpdateAll = arg_pnUpdateAll;
    _ = &pnUpdateAll;
    var pnDistSyncAll = arg_pnDistSyncAll;
    _ = &pnDistSyncAll;
    var pdwGlobalQueuePair = arg_pdwGlobalQueuePair;
    _ = &pdwGlobalQueuePair;
    var pnHasGlobalQueuePair = arg_pnHasGlobalQueuePair;
    _ = &pnHasGlobalQueuePair;
    var dwError: u32 = 0;
    _ = &dwError;
    var dwCount: u32 = 0;
    _ = &dwCount;
    var dwIndex: u32 = 0;
    _ = &dwIndex;
    var dwInstallCount: u32 = 0;
    _ = &dwInstallCount;
    var dwEraseCount: u32 = 0;
    _ = &dwEraseCount;
    var dwLockedCount: u32 = 0;
    _ = &dwLockedCount;
    var dwInstallOnlyCount: u32 = 0;
    _ = &dwInstallOnlyCount;
    var dwUserInstalledCount: u32 = 0;
    _ = &dwUserInstalledCount;
    var pJobs: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB = null;
    _ = &pJobs;
    var ppszLockedPkgs: [*c][*c]u8 = null;
    _ = &ppszLockedPkgs;
    ...
    _ = &pszJobRepo;
    var pszJobName: [*c]u8 = null;
    _ = &pszJobName;
    var pszJobVersion: [*c]u8 = null;
    _ = &pszJobVersion;
    var pszJobRelease: [*c]u8 = null;
    _ = &pszJobRelease;
    var pszJobArch: [*c]u8 = null;
    _ = &pszJobArch;
    var dwJobEpoch: u32 = 0;
    _ = &dwJobEpoch;
    var nUpdateAll: c_int = 0;
    _ = &nUpdateAll;
    var nDistSyncAll: c_int = 0;
    ...
    dwCount = pQueueJobs.*.dwCount / @as(u32, 2);
    dwError = TDNFAllocateMemory(dwCount +% @as(u32, 1), @sizeOf(@TypeOf(pJobs.*)), @ptrCast(@alignCast(&pJobs)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    dwError = TDNFAllocateMemory(dwCount +% @as(u32, 1), @sizeOf(@TypeOf(ppszLockedPkgs.*)), @ptrCast(@alignCast(&ppszLockedPkgs)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    dwError = TDNFAllocateMemory(dwCount +% @as(u32, 1), @sizeOf(@TypeOf(pdwLockedQueuePairs.*)), @ptrCast(@alignCast(&pdwLockedQueuePairs)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    dwError = TDNFAllocateMemory(dwCount +% @as(u32, 1), @sizeOf(@TypeOf(ppszCmdLinePaths.*)), @ptrCast(@alignCast(&ppszCmdLinePaths)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    dwError = TDNFAllocateMemory(dwCount +% @as(u32, 1), @sizeOf(@TypeOf(ppszInstallOnlyPkgs.*)), @ptrCast(@alignCast(&ppszInstallOnlyPkgs)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    ...
    }
    {
        ...
        while (dwIndex < dwCount) : (dwIndex +%= 1) {
            var nStamped: c_int = @intFromBool(@as(c_int, @bitCast(@as(c_uint, @truncate(dwIndex *% @as(u32, 2))))) < nStampedJobCount);
            _ = &nStamped;
            var rawHow: i32 = pQueueJobs.*.pnElements[dwIndex *% @as(u32, 2)];
            _ = &rawHow;
            var how: i32 = if (nStamped != 0) rawHow ^ nStampFlags else rawHow;
            _ = &how;
            var nRawWhat: i32 = pQueueJobs.*.pnElements[(dwIndex *% @as(u32, 2)) +% @as(u32, 1)];
            _ = &nRawWhat;
            var dwPkgId: TDNF_PKG_ID = nRawWhat;
            _ = &dwPkgId;
            var nIsInstalled: c_int = 0;
            _ = &nIsInstalled;
            var pJob: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB = null;
            _ = &pJob;
            var nInstall: c_int = @intFromBool(how == (TDNF_JOB_SOLVABLE | TDNF_JOB_INSTALL));
            _ = &nInstall;
            var nErase: c_int = @intFromBool((nStamped != 0) and (how == (TDNF_JOB_SOLVABLE | TDNF_JOB_ERASE)));
            _ = &nErase;
            var nUserInstalled: c_int = @intFromBool((how == (TDNF_JOB_SOLVABLE | TDNF_JOB_USERINSTALLED)) or (rawHow == (TDNF_JOB_SOLVABLE | TDNF_JOB_USERINSTALLED)));
            _ = &nUserInstalled;
            var nAllowUninstall: c_int = @intFromBool(rawHow == (TDNF_JOB_SOLVABLE | TDNF_JOB_ALLOWUNINSTALL));
            _ = &nAllowUninstall;
            var nLocked: c_int = @intFromBool(rawHow == (TDNF_JOB_SOLVABLE_NAME | TDNF_JOB_LOCK));
            _ = &nLocked;
            var nInstallOnly: c_int = @intFromBool(rawHow == (TDNF_JOB_SOLVABLE_NAME | TDNF_JOB_MULTIVERSION));
            _ = &nInstallOnly;
            var nUpdateAllJob: c_int = @intFromBool(how == (TDNF_JOB_SOLVABLE_ALL | TDNF_JOB_UPDATE));
            _ = &nUpdateAllJob;
            var nDistSyncAllJob: c_int = @intFromBool(how == (TDNF_JOB_SOLVABLE_ALL | TDNF_JOB_DISTUPGRADE));
            _ = &nDistSyncAllJob;
            if (!(nStamped != 0) and (how == (TDNF_JOB_SOLVABLE | TDNF_JOB_ERASE))) continue;
            if (((((nUpdateAllJob != 0) or (nDistSyncAllJob != 0)) and !(nRawWhat != 0)) and !(nUpdateAll != 0)) and !(nDistSyncAll != 0)) {
            ...
            if (nLocked != 0) {
                var pszName: [*c]const u8 = null;
                _ = &pszName;
                if (((nRawWhat < @as(c_int, 0)) or !(pTdnf.*.pConf.*.ppszPkgLocks != null)) or !((blk: {
                    const tmp = pTdnf.*.pConf.*.ppszPkgLocks[@bitCast(@as(isize, @intCast(nRawWhat)))];
                    pszName = tmp;
                    break :blk tmp;
                }) != null)) {
                    dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
                ...
                ppszLockedPkgs[
                    blk: {
                        const ref = &dwLockedCount;
                        const tmp = ref.*;
                        ref.* +%= 1;
                        break :blk tmp;
                    }
                ] = @ptrCast(@alignCast(@constCast(pszName)));
                continue;
            }
            if (nInstallOnly != 0) {
                var pszName: [*c]const u8 = null;
                _ = &pszName;
                if (((nRawWhat < @as(c_int, 0)) or !(pTdnf.*.pConf.*.ppszInstallOnlyPkgs != null)) or !((blk: {
                    const tmp = pTdnf.*.pConf.*.ppszInstallOnlyPkgs[@bitCast(@as(isize, @intCast(nRawWhat)))];
                    pszName = tmp;
                    break :blk tmp;
                }) != null)) {
                    dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
            ...
            if (((!(nInstall != 0) and !(nErase != 0)) and !(nUserInstalled != 0)) and !(nAllowUninstall != 0)) {
                dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
            ...
            if (TDNFNativeQuerySerializePackageId(pTdnf.*.pSack, dwPkgId, &pszJobRef) != 0) {
                dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
            ...
            while (true) {
                if (pszJobRepo != null) {
                    TDNFFreeMemory(@ptrCast(@alignCast(pszJobRepo)));
                    pszJobRepo = null;
                }
                if (!false) break;
            }
            while (true) {
                if (pszJobName != null) {
                    TDNFFreeMemory(@ptrCast(@alignCast(pszJobName)));
                    pszJobName = null;
                }
                if (!false) break;
            }
            while (true) {
                if (pszJobVersion != null) {
                    TDNFFreeMemory(@ptrCast(@alignCast(pszJobVersion)));
                    pszJobVersion = null;
                }
                if (!false) break;
            }
            while (true) {
                if (pszJobRelease != null) {
                    TDNFFreeMemory(@ptrCast(@alignCast(pszJobRelease)));
                    pszJobRelease = null;
                }
                if (!false) break;
            }
            while (true) {
                if (pszJobArch != null) {
                    TDNFFreeMemory(@ptrCast(@alignCast(pszJobArch)));
                    pszJobArch = null;
                }
                if (!false) break;
            }
            if (TDNFNativeQuerySplitPackageRef(pszJobRef, &pszJobRepo, &dwJobEpoch, &pszJobName, &pszJobVersion, &pszJobRelease, &pszJobArch) != 0) {
                dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
            ...
            nIsInstalled = @intFromBool(!(strcmp(pszJobRepo, "@System") != 0));
            if ((if (nInstall != 0) nIsInstalled else @intFromBool(!(nIsInstalled != 0))) != 0) {
                dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
            ...
            pJob = if (nInstall != 0) &pJobs[
                blk: {
                    const ref = &dwInstallCount;
                    const tmp = ref.*;
                    ref.* +%= 1;
                    break :blk tmp;
                }
            ...
            pszJobRepo = null;
            if (!(strcmp(pJob.*.pszRepository, "@cmdline") != 0)) {
                dwError = TDNFFindCmdLinePkgPath(pTdnf, dwPkgId, &ppszCmdLinePaths[dwInstallCount -% @as(u32, 1)]);
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
                }
    ...
    if (((nUpdateAll != 0) or (nDistSyncAll != 0)) and (dwCount != (((dwLockedCount +% dwInstallOnlyCount) +% dwUserInstalledCount) +% @as(u32, 1)))) {
        dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + ENOSYS));
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
    ...
    _ = memmove(@ptrCast(@alignCast(pJobs + dwInstallCount)), @ptrCast(@alignCast((pJobs + dwCount) - dwEraseCount)), @as(c_ulong, dwEraseCount) *% @sizeOf(@TypeOf(pJobs.*)));
    ppJobs.* = pJobs;
    pdwJobCount.* = dwInstallCount;
    ppEraseJobs.* = @ptrCast(@alignCast(if (dwEraseCount != 0) @as(?*anyopaque, @ptrCast(@alignCast(pJobs + dwInstallCount))) else @as(?*anyopaque, null)));
...
pub fn TDNFGoalFreeNativeSolverJobs(arg_pJobs: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB, arg_dwJobCount: u32) callconv(.c) void {
    var pJobs = arg_pJobs;
    _ = &pJobs;
    var dwJobCount = arg_dwJobCount;
    _ = &dwJobCount;
    var dwIndex: u32 = 0;
    _ = &dwIndex;
    if (!(pJobs != null)) {
    ...
    }
    {
        ...
        while (dwIndex < dwJobCount) : (dwIndex +%= 1) {
            ...
            _ = &pszVersion;
            var pszRelease: [*c]u8 = @ptrCast(@alignCast(@constCast(pJobs[dwIndex].pszRelease)));
            _ = &pszRelease;
            var pszArch: [*c]u8 = @ptrCast(@alignCast(@constCast(pJobs[dwIndex].pszArch)));
            _ = &pszArch;
            var pszRepository: [*c]u8 = @ptrCast(@alignCast(@constCast(pJobs[dwIndex].pszRepository)));
            _ = &pszRepository;
            while (true) {
                if (pszName != null) {
            ...
            while (true) {
                if (pszRepository != null) {
                    TDNFFreeMemory(@ptrCast(@alignCast(pszRepository)));
                    pszRepository = null;
                }
                if (!false) break;
            }
    ...
    while (true) {
        if (pJobs != null) {
            TDNFFreeMemory(@ptrCast(@alignCast(pJobs)));
            pJobs = null;
        }
        if (!false) break;
    }
}
pub fn TDNFGoalBuildNativeSolverHiddenAvailable(arg_pTdnf: PTDNF, arg_ppHiddenAvailable: [*c]PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB, arg_pdwHiddenAvailableCount: [*c]u32) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var ppHiddenAvailable = arg_ppHiddenAvailable;
    _ = &ppHiddenAvailable;
    var pdwHiddenAvailableCount = arg_pdwHiddenAvailableCount;
    _ = &pdwHiddenAvailableCount;
    var dwError: u32 = 0;
    _ = &dwError;
    var dwCount: u32 = 0;
    _ = &dwCount;
    ...
    if (!(pTdnf.*.dwHiddenRefCount != 0)) {
        return dwError;
    }
    dwError = TDNFAllocateMemory(pTdnf.*.dwHiddenRefCount, @sizeOf(TDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB), @ptrCast(@alignCast(&pHiddenAvailable)));
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    ...
    {
        i = 0;
        while (i < pTdnf.*.dwHiddenRefCount) : (i +%= 1) {
            var nSkip: c_int = 0;
            _ = &nSkip;
            dwError = TDNFGoalSplitHiddenRef(pTdnf.*.ppszHiddenRefs[i], &pHiddenAvailable[dwIndex], &nSkip);
            while (true) {
                if (dwError != @as(u32, 0)) return dwError;
                if (!false) break;
            }
...
pub fn TDNFGoalSplitHiddenRef(arg_pszRef: [*c]const u8, arg_pJob: PTDNF_REPOMD_NATIVE_SOLVER_LIVE_JOB, arg_pnSkip: [*c]c_int) callconv(.c) u32 {
    var pszRef = arg_pszRef;
    _ = &pszRef;
    var pJob = arg_pJob;
    _ = &pJob;
    var pnSkip = arg_pnSkip;
    _ = &pnSkip;
    var dwError: u32 = 0;
    _ = &dwError;
    var pszRepo: [*c]u8 = null;
    ...
    if (!(strcmp(pszRepo, "@System") != 0) or !(strcmp(pszRepo, "@cmdline") != 0)) {
        pnSkip.* = 1;
        return dwError;
    }
...
pub fn TDNFReportProblemsNative(arg_pTdnf: PTDNF, arg_pQueueJobs: [*c]const TDNF_ID_LIST, arg_nAllowErasing: c_int, arg_nAutoErase: c_int, arg_nStampFlags: c_int, arg_nStampedJobCount: c_int, arg_dwSkipProblem: TDNF_SKIPPROBLEM_TYPE) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var pQueueJobs = arg_pQueueJobs;
    _ = &pQueueJobs;
    ...
    dwError = TDNFGoalSolveNative(pTdnf, pQueueJobs, nAllowErasing, nAutoErase, nStampFlags, nStampedJobCount, 0, null, 0, 1, 0, &pHandle);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
...
pub fn TDNFGoalFindProtectedInTransaction(arg_pTdnf: PTDNF, arg_pQueueJobs: [*c]const TDNF_ID_LIST, arg_nAllowErasing: c_int, arg_nAutoErase: c_int, arg_nStampFlags: c_int, arg_nStampedJobCount: c_int, arg_ppszName: [*c][*c]const u8, arg_ppszAction: [*c][*c]const u8) callconv(.c) u32 {
    ...
    dwError = TDNFGoalSolveNative(pTdnf, pQueueJobs, nAllowErasing, nAutoErase, nStampFlags, nStampedJobCount, 0, &pInfo, 0, 0, 1, null);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
    pszName = TDNFFindProtectedPkg(pTdnf.*.pConf.*.ppszProtectedPkgs, @ptrCast(@alignCast(if (pInfo != null) @as(?*anyopaque, @ptrCast(@alignCast(pInfo.*.pPkgsObsoleted))) else @as(?*anyopaque, null))));
    if (pszName != null) {
        pszAction = "obsoleted";
    } else {
        pszName = TDNFFindProtectedPkg(pTdnf.*.pConf.*.ppszProtectedPkgs, @ptrCast(@alignCast(if (pInfo != null) @as(?*anyopaque, @ptrCast(@alignCast(pInfo.*.pPkgsToRemove))) else @as(?*anyopaque, null))));
        if (pszName != null) {
            pszAction = "removed";
        }
    }
...
pub fn TDNFFindProtectedPkg(arg_ppszProtectedPkgs: [*c][*c]u8, arg_pPkgs: PTDNF_PKG_INFO) callconv(.c) [*c]const u8 {
    var ppszProtectedPkgs = arg_ppszProtectedPkgs;
    _ = &ppszProtectedPkgs;
    var pPkgs = arg_pPkgs;
    _ = &pPkgs;
    var pPkg: PTDNF_PKG_INFO = null;
    _ = &pPkg;
    var i: c_int = 0;
    _ = &i;
    if (!(ppszProtectedPkgs != null)) {
        return null;
    }
    {
        pPkg = pPkgs;
        while (pPkg != null) : (pPkg = pPkg.*.pNext) {
            if (!(pPkg.*.pszName != null) or !(@as(c_int, pPkg.*.pszName.*) != 0)) {
                continue;
            }
            {
                i = 0;
                while (ppszProtectedPkgs[@bitCast(@as(isize, @intCast(i)))] != null) : (i += 1) {
                    if (!(strcmp(ppszProtectedPkgs[@bitCast(@as(isize, @intCast(i)))], pPkg.*.pszName) != 0)) {
                        return ppszProtectedPkgs[@bitCast(@as(isize, @intCast(i)))];
                    }
                }
            }
...
pub fn TDNFGoalLoadInstalledPkgs(arg_pTdnf: PTDNF, arg_ppPkgInfo: [*c]PTDNF_PKG_INFO, arg_pdwCount: [*c]u32) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var ppPkgInfo = arg_ppPkgInfo;
    _ = &ppPkgInfo;
    var pdwCount = arg_pdwCount;
    _ = &pdwCount;
    var dwError: u32 = 0;
    _ = &dwError;
    if ((!(pTdnf != null) or !(ppPkgInfo != null)) or !(pdwCount != null)) {
        dwError = @bitCast(@as(c_int, ERROR_TDNF_SYSTEM_BASE + EINVAL));
        while (true) {
            if (dwError != @as(u32, 0)) return dwError;
            if (!false) break;
    ...
    dwError = TDNFRepoMdNativeListConfig(null, 0, pTdnf.*.pRpmConfig, SCOPE_INSTALLED, null, DETAIL_LIST, ppPkgInfo, pdwCount);
    while (true) {
        if (dwError != @as(u32, 0)) return dwError;
        if (!false) break;
    }
...
pub fn TDNFGoalNameIsInstalled(arg_pszName: [*c]const u8, arg_pPkgInfo: PTDNF_PKG_INFO, arg_dwInstalledCount: u32) callconv(.c) c_int {
    var pszName = arg_pszName;
    _ = &pszName;
    var pPkgInfo = arg_pPkgInfo;
    _ = &pPkgInfo;
    var dwInstalledCount = arg_dwInstalledCount;
    _ = &dwInstalledCount;
    var i: u32 = 0;
    _ = &i;
    if ((!(pszName != null) or !(@as(c_int, pszName.*) != 0)) or !(pPkgInfo != null)) {
        return 0;
    }
    {
        i = 0;
        while (i < dwInstalledCount) : (i +%= 1) {
            if (!(!(pPkgInfo[i].pszName != null) or !(@as(c_int, pPkgInfo[i].pszName.*) != 0)) and (strcmp(pPkgInfo[i].pszName, pszName) == @as(c_int, 0))) {
                return 1;
            }
        }
    }
...
pub fn TDNFAddUserInstalledToJobs(arg_pTdnf: PTDNF, arg_pQueueJobs: PTDNF_ID_LIST) callconv(.c) u32 {
    var pTdnf = arg_pTdnf;
    _ = &pTdnf;
    var pQueueJobs = arg_pQueueJobs;
    _ = &pQueueJobs;
    ...
    }
    {
        ...
        while (k < @as(c_int, @bitCast(@as(c_uint, @truncate(qInstalled.dwCount))))) : (k += 1) {
            ...
            if (history_get_auto_flag(pHistoryCtx, pszName, &nAutoFlag) != @as(c_int, 0)) {
                dwError = ERROR_TDNF_HISTORY_ERROR;
                while (true) {
                    if (dwError != @as(u32, 0)) return dwError;
                    if (!false) break;
...
comptime {
    ...
    {
        @compileError("solver ABI declarations differ from client/abi.zig");
    }
}
