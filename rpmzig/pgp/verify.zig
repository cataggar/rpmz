...
//     --digest-algo SHA512`. Pure-Zig verdict here must match GnuPG's
//     verdict — this nails the OpenPGP-Ed25519 hash interpretation
//     against the canonical implementation. The matching private key
//     was discarded immediately after fixture generation.
...
test "EdDSALegacy: real gpg-signed fixture verifies" {
